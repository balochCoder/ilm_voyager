...
final class EditSubStatusRequest extends FormRequest
{
    /**
        ...
        return [
            'name' => [
                ...
                Rule::unique('sub_statuses', 'name')
                    ->where('rep_country_status_id', $this->route('subStatus')->rep_country_status_id)
                    ->ignore($this->route('subStatus')->id),
            ],
        ];
    }
