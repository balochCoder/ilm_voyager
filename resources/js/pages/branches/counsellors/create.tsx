...
const breadcrumbs = [
  ...
  { title: 'Add Counsellor', href: '/branch-office/counsellors/create' },
];

export default function CreateCounsellor() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    post(route('branches:counsellors:store'));
  };
      ...
      <div className="flex flex-col gap-4 p-4 sm:p-6">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 min-w-0">
          <div className="flex-1 min-w-0">
            <Heading title="Add Counsellor" description="Create a new counsellor for your branch." />
          </div>
