...
import { ArrowLeft, FileIcon, FileText, ImageIcon, Plus } from 'lucide-react';
...
export default function BranchAssociateCreate({ countries }: Props) {
    const [countriesState, setCountriesState] = useState<Country[]>(countries || []);
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post(route('branches:associates:store'), {
            forceFormData: true,
            onSuccess: () => {
                reset();
            },
            ...
            <div className="flex flex-col gap-4 p-4 sm:p-6">
                <div className="flex min-w-0 flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
                    <div className="min-w-0 flex-1">
                        <Heading title="Add Associate" description="Create a new associate for your branch." />
                    </div>
