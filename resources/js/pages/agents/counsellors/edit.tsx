...
const breadcrumbs = [
  ...
  { title: 'Edit Counsellor', href: '/agents/counsellors/edit' },
];
...
export default function EditCounsellor({ counsellor, branches = [] }: Props) {
  ...
  const { data, setData, put, processing, errors } = useForm({
    ...
    branch_id: counsellor.branch_id,
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    put(route('agents:counsellors:update', { counsellor: counsellor.id }));
  };
